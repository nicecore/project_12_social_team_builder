...
urlpatterns = [
    ...
    url(r"project/(?P<project_pk>\d+)/$",
        views.project_detail, name='project_detail'),
    url(r"project/(?P<pk>\d+)/edit/$",
        views.EditProject.as_view(), name='edit_project'),
    url(r"project/(?P<project_pk>\d+)/position/new/$",
        views.new_position, name="new_position"),
    url(r"project/(?P<project_pk>\d+)/delete/$",
        views.delete_project, name="delete"),
